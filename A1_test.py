...
def task1():
    ...
    dict_list = solution_A1.load_dictionary("engmix.txt")
    ...
    word_list = solution_A1.text_to_words(plaintext1)
    print("plaintext1:", word_list)

    plaintext2 = utilities.file_to_text("plaintext12.txt")
    word_list = solution_A1.text_to_words(plaintext2)
    print("plaintext2:")
    print(word_list)

    plaintext3 = utilities.file_to_text("plaintext13.txt")
    word_list = solution_A1.text_to_words(plaintext3)
    print("plaintext3:")
    print(word_list)
    print()
...
def task2():
    ...
    for i in range(5):
        ciphertext = solution_A1.e_eatbash(plaintext,i+5)
        print('key = {}'.format(i))
        print('ciphertext: ')
        print(ciphertext)
    ...
    for i in range(5):
        ...
        plaintext = solution_A1.d_eatbash(ciphertext,i)
        print('key = {}'.format(i))
        print('plaintext: ')
        print(plaintext)
        print()
    ...
    for i in range(5):
        ...
        key,plaintext = solution_A1.cryptanalysis_eatbash(ciphertext)
...
def task3():
    ...
    for i in range(3,7):
        ...
        ciphertext = solution_A1.e_scytale(plaintext,i)
        print('key = {}'.format(i))
        print('ciphertext: ')
        print(ciphertext)
    ...
    for i in range(3,7):
        ...
        plaintext = solution_A1.d_scytale(ciphertext,i)
        print('key = {}'.format(i))
        print('plaintext: ')
        print(plaintext)
        print()
    ...
    for i in range(5,7):
        ...
        ciphertext = utilities.file_to_text(file)
        key,plaintext = solution_A1.cryptanalysis_scytale(ciphertext)
        print('key = {}'.format(key),end=' , ')
...
def task4():
    ...
    print('start = "A", size = 5: {}'.format(solution_A1.get_polybius_square('A',5)))
    print('start = "R", size = 6: {}'.format(solution_A1.get_polybius_square('R',6)))
    print('start = "@", size = 7: {}'.format(solution_A1.get_polybius_square('@',7)))
    print('start = "A", size = 5: {}'.format(solution_A1.get_polybius_square('A',5)))
    print('start = " ", size = 8: {}'.format(solution_A1.get_polybius_square(' ',8)))
    print('start = "+", size = 9: {}'.format(solution_A1.get_polybius_square('+',9)))
    print('start = " ", size = 10: {}'.format(solution_A1.get_polybius_square(' ',10)))
    print()
    ...
    for i in range(1,6):
        ...
        plaintext = utilities.file_to_text(plainfile)
        key = (start[i-1],i+5)
        ciphertext = solution_A1.e_polybius(plaintext,key)
    ...
    for i in range(1,6):
        ...
        key = (start[i-1],i+5)
        plaintext = solution_A1.d_polybius(ciphertext,key)
        print('key = {}'.format(key))
        print('plaintext: ')
        print(plaintext)
        print()
    ...
    for i in range(6,9):
        ...
        ciphertext = utilities.file_to_text(file)
        key,plaintext = solution_A1.cryptanalysis_polybius(ciphertext,size[i-6])
        print('key = {} --> {}'.format(key,solution_A1.get_polybius_square(key[0],key[1])),end=' , ')
